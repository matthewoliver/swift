...
class ReconMiddleware(object):
    ...
    def __init__(self, app, conf, *args, **kwargs):
        ...
        self.ring_manager_agent_recon_cache = os.path.join(
    ...
    def get_ring_manager_agent_info(self):
        ...
        return self._from_recon_cache(['ring_manager_agent'],
                                      self.ring_manager_agent_recon_cache,
                                      ignore_missing=True)
    ...
    def GET(self, req):
        ...
        elif rcheck == "ring_manager_agent":
            content = self.get_ring_manager_agent_info()
